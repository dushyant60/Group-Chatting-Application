...
public class User2 implements ActionListener, Runnable {
    ...
    User2() {
        ...
        // Labels
        JLabel name = new JLabel("Gang");
        name.setBounds(90, 15, 200, 25);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Slim Shadey, Shadey, Snoop, Eminem, JayZ");
        status.setBounds(90, 35, 200, 25);
